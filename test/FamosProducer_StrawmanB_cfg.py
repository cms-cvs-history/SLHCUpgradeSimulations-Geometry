...
process.SiPixelFakeGainOfflineESSource.file = 'SLHCUpgradeSimulations/Geometry/data/strawmanb/PixelSkimmedGeometry_empty.txt'
...
process.ReadLocalMeasurement = cms.EDAnalyzer("StdHitNtuplizer",
   ...
   OutputFile = cms.string("stdgrechitstrawb_ntuple.root"),
...
process.o1 = cms.OutputModule(
    ...
    outputCommands = cms.untracked.vstring('keep *',
                                           'drop *_mix_*_*'),
    fileName = cms.untracked.string('/uscms_data/d2/cheung/slhc/fastsimstrawb_50mu.root')
)
