...
process.multiTrackValidator.outputFile = "validstrawa_muon_50GeV.root"
...
#   FilePath = cms.untracked.string("PixelSkimmedGeometry_strawa.txt")
#)
...
process.o1 = cms.OutputModule(
    ...
    outputCommands = cms.untracked.vstring('keep *',
                                           'drop *_mix_*_*'),
    fileName = cms.untracked.string('/uscms_data/d2/cheung/slhc/strawa_muon_50GeV.root')
)
...
process.MessageLogger.destinations = cms.untracked.vstring("detailedInfo_strawa_mu50")
### to output debug messages for particular modules
#process.MessageLogger.detailedInfo_strawa_mu50 = cms.untracked.PSet(threshold = cms.untracked.string('DEBUG'))
