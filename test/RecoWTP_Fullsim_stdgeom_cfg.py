...
#  fileNames = cms.untracked.vstring('/store/user/cheung/stdgeom/muon/TenMuon1-10GeV_RAWSIM_0pu.root'),
#  fileNames = cms.untracked.vstring('/store/user/cheung/slhc_stdgeom_ttbar_pu50/slhc_stdgeom_ttbar_pu50/1b1430304a5442610cdc5f8eb6406738/TTbar_GEN_SIM_DIGI_1_1.root'),
  #fileNames = cms.untracked.vstring('/store/user/cheung/slhc_stdgeom_ttbar_pu25/slhc_stdgeom_ttbar_pu25/2df1c3cd5d23102fd9340578b186aff6/TTbar_GEN_SIM_DIGI_1_1.root'),
...
#process.MessageLogger.destinations = cms.untracked.vstring("detailedInfo_fullstdgeom")
...
# should add them to fakeConditions_stdgeom_cff
...
process.TPanalysis = cms.Sequence(process.cutsTPEffic*process.cutsTPFake*process.cutsRecoTracksHp*process.cutsRecoTracksZeroHp*process.TPanal)
...
process.user_step = cms.Path(process.TPanalysis)
...
process.schedule = cms.Schedule(process.mix_step,process.reconstruction_step,process.user_step,process.endjob_step,process.out_step)
