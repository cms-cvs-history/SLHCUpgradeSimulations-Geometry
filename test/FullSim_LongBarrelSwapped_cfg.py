...
process.load('SLHCUpgradeSimulations.Geometry.LongBarrelSwapped_cmsSimIdealGeometryXML_cff')
...
process.load('SLHCUpgradeSimulations.Geometry.fakeConditions_LongBarrelSwapped_cff')
process.load('SLHCUpgradeSimulations.Geometry.Digi_LongBarrelSwapped_cff')
process.load('SLHCUpgradeSimulations.Geometry.recoFromSimDigis_LongBarrelSwapped_cff')
...
#StubsFromSimHits = [ "2d" , "globalgeometry" ]
#StubsFromDigis = [ "2d" , "pixelray" ]
...
#process.MessageLogger.destinations = cms.untracked.vstring("detailedInfo_fullbarrel")
#process.MessageLogger.detailedInfo_fullbarrel = cms.untracked.PSet(threshold = cms.untracked.string('DEBUG'))
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Minbias_GEN_SIM_DIGI_2sps.root'),
...
process.siPixelFakeGainOfflineESSource = cms.ESSource("SiPixelFakeGainOfflineESSource",
    file = cms.FileInPath('SLHCUpgradeSimulations/Geometry/data/LongBarrelSwapped/EmptyPixelSkimmedGeometry.txt')
)
...
process.siPixelFakeLorentzAngleESSource = cms.ESSource("SiPixelFakeLorentzAngleESSource",
    file = cms.FileInPath('SLHCUpgradeSimulations/Geometry/data/LongBarrelSwapped/PixelSkimmedGeometry.txt')
)
...
#process.cluster_step=cms.Path(process.L1TkClustersFromPixelDigis)
