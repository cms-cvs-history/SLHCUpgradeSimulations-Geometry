...
pixellessStepLoose.dz_par1 = cms.vdouble(1.395, 4.0) # 1.5
pixellessStepLoose.dz_par2 = cms.vdouble(1.395, 4.0) # 1.5
pixellessStepLoose.d0_par1 = cms.vdouble(1.395, 4.0) # 1.5
pixellessStepLoose.d0_par2 = cms.vdouble(1.395, 4.0) # 1.5
pixellessStepTight.dz_par1 = cms.vdouble(1.116, 4.0) # 1.2
pixellessStepTight.dz_par2 = cms.vdouble(1.116, 4.0) # 1.2
pixellessStepTight.d0_par1 = cms.vdouble(1.116, 4.0) # 1.2
pixellessStepTight.d0_par2 = cms.vdouble(1.116, 4.0) # 1.2
pixellessStep.dz_par1 = cms.vdouble(0.93, 4.0) # 1.
pixellessStep.dz_par2 = cms.vdouble(0.93, 4.0) # 1.
pixellessStep.d0_par1 = cms.vdouble(0.93, 4.0) # 1.
pixellessStep.d0_par2 = cms.vdouble(0.93, 4.0) # 1.

tobtecStepLoose.dz_par1 = cms.vdouble(1.395, 4.0) # 1.5
tobtecStepLoose.dz_par2 = cms.vdouble(1.395, 4.0) # 1.5
tobtecStepLoose.d0_par1 = cms.vdouble(1.674, 4.0) # 1.8
tobtecStepLoose.d0_par2 = cms.vdouble(1.674, 4.0) # 1.8
tobtecStepTight.dz_par1 = cms.vdouble(1.116, 4.0) # 1.2
tobtecStepTight.dz_par2 = cms.vdouble(1.209, 4.0) # 1.3
tobtecStepTight.d0_par1 = cms.vdouble(1.116, 4.0) # 1.2
tobtecStepTight.d0_par2 = cms.vdouble(1.209, 4.0) # 1.3
tobtecStep.dz_par1 = cms.vdouble(1.023, 4.0) # 1.1
tobtecStep.dz_par2 = cms.vdouble(1.023, 4.0) # 1.1
tobtecStep.d0_par1 = cms.vdouble(1.116, 4.0) # 1.2
tobtecStep.d0_par2 = cms.vdouble(1.116, 4.0) # 1.2
...
######## OLD STUFF
## # remove combined seed (pair seed no more implemented) was here for backward compatibility with electron reconstruction
## ckftracks_wodEdXandCombinedSeeds = ckftracks_wodEdX.copy()
## ckftracks_wodEdXandCombinedSeeds.remove(newCombinedSeeds)
