...
#    file = cms.FileInPath('SLHCUpgradeSimulations/Geometry/data/hybrid/PixelSkimmedGeometry.txt')
    file = cms.FileInPath('SLHCUpgradeSimulations/Geometry/data/hybrid/EmptyPixelSkimmedGeometry.txt')
)
...
#process.MessageLogger.destinations = cms.untracked.vstring("detailedInfo_fullhybridmu50")
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/uscms_data/d2/cheung/slhc/testfullhybrid_muon_50GeV.root')
)
...
process.multiTrackValidator.outputFile = "validfullhybrid_muon_50GeV.root"
...
process.mergedtruth.simHitCollections.tracker = cms.vstring("g4SimHitsTrackerHitsTOBLowTof",
                                              "g4SimHitsTrackerHitsTOBHighTof",
                                              "g4SimHitsTrackerHitsTECLowTof",
                                              "g4SimHitsTrackerHitsTECHighTof")
...
process.ReadLocalMeasurement = cms.EDAnalyzer("StdHitNtuplizer",
   ...
   OutputFile = cms.string("stdgrechitfullHY_ntuple.root"),
...
#process.p8 = cms.Path(process.anal*process.ReadLocalMeasurement)
